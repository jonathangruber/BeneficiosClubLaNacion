...
public class BeneficioItemAdapter extends ArrayAdapter<Beneficio> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.distancia.setText(String.valueOf(cuadras).concat(" cuadra/s"));
        ...
        String color = beneficio.getDatosBeneficio().getColor();
        color = "#CC".concat(color);
        holder.lugar.setBackgroundColor(Color.parseColor(color));
        holder.descuento.setBackgroundColor(Color.parseColor(color));
        holder.distancia.setBackgroundColor(Color.parseColor(color));
